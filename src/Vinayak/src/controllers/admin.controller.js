...
const getWhyChooseUs = catchAsync(async (req, res) => {
  const chooseUsData = await adminService.getWhyUs(req.body);
...
const createWhyUs = catchAsync(async (req, res) => {
  const whyUs = await adminService.createWhyUs(req.body);
  sendSuccessResponse(res, 'post', whyUs)
});

const getWhyUs = catchAsync(async (req, res) => {
  const whyUs = await adminService.getWhyUs(req.body);
  sendSuccessResponse(res, 'get', whyUs)
});

const updateWhyUs = catchAsync(async (req, res) => {
  const whyUs = await adminService.updateWhyUs(req.params.id, req.body);
  sendSuccessResponse(res, 'put', whyUs)
});

const deleteWhyUs = catchAsync(async (req, res) => {
  const whyUs = await adminService.deleteWhyUs(req.params.id);
  sendSuccessResponse(res, 'delete', whyUs)
});
...
const createCalculation = catchAsync(async (req, res) => {
  ...
  sendSuccessResponse(res, 'create', calculation);
});
...
const updateCalculation = catchAsync(async (req, res) => {
  ...
  sendSuccessResponse(res, 'update', calculation)
});
...
const createWhatWeDo = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.createWhatWeDo(req.body);
  sendSuccessResponse(res, 'create', whatWeDo);
});

const getWhatWeDo  = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.getWhatWeDo(req.body);
  sendSuccessResponse(res, 'get', whatWeDo)
});

const updateWhatWeDo = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.updateWhatWeDo(req.params.id, req.body);
  sendSuccessResponse(res, 'update', whatWeDo)
});

const deleteWhatWeDo = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.deleteWhatWeDo(req.params.id);
  sendSuccessResponse(res, 'delete', whatWeDo)
});


const createServe = catchAsync(async (req, res) => {
  const serve = await adminService.createServe(req.body);
  sendSuccessResponse(res, 'create', serve);
});

const getServe  = catchAsync(async (req, res) => {
  const serve = await adminService.getServe(req.body);
  sendSuccessResponse(res, 'get', serve)
});

const updateServe = catchAsync(async (req, res) => {
  const serve = await adminService.updateServe(req.params.id, req.body);
  sendSuccessResponse(res, 'update', serve)
});

const deleteServe = catchAsync(async (req, res) => {
  const serve = await adminService.deleteServe(req.params.id);
  sendSuccessResponse(res, 'delete', serve)
});

const createWhatWeDoMain = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.createWhatWeDoMain(req.body);
  sendSuccessResponse(res, 'create', whatWeDo);
});

const getAllWhatWeDoMain  = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.getAllWhatWeDoMain(req.body);
  sendSuccessResponse(res, 'get', whatWeDo)
});

const updateWhatWeDoMain = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.updateWhatWeDoMain(req.params.id, req.body);
  sendSuccessResponse(res, 'update', whatWeDo)
});

const deleteWhatWeDoMain = catchAsync(async (req, res) => {
  const whatWeDo = await adminService.deleteWhatWeDoMain(req.params.id);
  sendSuccessResponse(res, 'delete', whatWeDo)
});
...
createCompanyInfo, getCompanyInfo, updateCompanyInfo, deleteCompanyInfo, addAboutUsPage, getAboutUsPage, getAboutUsById, updateAboutUsPage, deleteAboutUsPage, createCalculation, getCalculation, updateCalculation, deleteCalculation,
addBlog, getBlog, updateBlog, deleteBlog, createWhatWeOffer, getWhatWeOffer, updateWhatWeOffer, deleteWhatWeOffer, createWhyUs, getWhyUs, updateWhyUs, deleteWhyUs, getContacts,
...
createWhatWeDo, getWhatWeDo, updateWhatWeDo, deleteWhatWeDo, createServe, getServe, updateServe, deleteServe, createWhatWeDoMain, getAllWhatWeDoMain, updateWhatWeDoMain, deleteWhatWeDoMain,
