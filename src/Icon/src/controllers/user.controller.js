...
const createContact = async (req, res) => {
  try {
    ...
    const contactData = { firstName, email, lastName, phone, message };
...
createOrderSummaryHandler, getOrderSummaryById, updateOrderSummaryByIdHandler, deleteOrderSummaryByIdHandler, getOrdersByUserId, getAllOrders, createContact, getContacts, getContact,
 getUserById, getCoupon, getCouponById, getBlog, getAboutUsPage, getAboutUsById, createWhyChoose, getAllWhyChoose, updateWhyChoose, deleteWhyChoose,}