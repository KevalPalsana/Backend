...
const createFeedback = [
    ...
    async (req, res) => {
        try {
            ...
            const newForm = new SorathiyaVadiPremvati({
                ...feedbackData,
...
const getFeedbacks = async (req, res) => {
    try {
        const feedbacks = await SorathiyaVadiPremvati.find();
        res.json({feedbacks});
    } catch (error) {
...
const assignFeedback = async (req, res) => {
    ...
    try {
        const feedback = await SorathiyaVadiPremvati.findById(id);
...
const getFeedbacksByRole = async (req, res) => {
    try {
        ...
        const feedbacks = await SorathiyaVadiPremvati.find(query);
...
const deleteFeedback = async (req, res) => {
    try {
      ...
      const deletedRecord = await SorathiyaVadiPremvati.findByIdAndDelete(id);
