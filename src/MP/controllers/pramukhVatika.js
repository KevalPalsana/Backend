...
const createFeedback = [
    ...
    async (req, res) => {
        try {
            ...
            const newForm = new PramukhVatikaPremvati({
                ...feedbackData,
...
const getFeedbacks = async (req, res) => {
    try {
        const feedbacks = await PramukhVatikaPremvati.find();
        res.json({feedbacks});
    } catch (error) {
...
const assignFeedback = async (req, res) => {
    ...
    try {
        const feedback = await PramukhVatikaPremvati.findById(id);
...
const getFeedbacksByRole = async (req, res) => {
    try {
        ...
        const feedbacks = await PramukhVatikaPremvati.find(query);
...
const deleteFeedback = async (req, res) => {
    try {
      ...
      const deletedRecord = await PramukhVatikaPremvati.findByIdAndDelete(id);
      ...
      console.error('Error deleting DholakiyaPremvati record:', error);
