...
const createFeedback = [
    ...
    async (req, res) => {
        try {
            ...
            const newForm = new TirupatiPremvati({
                ...feedbackData,
...
const getFeedbacks = async (req, res) => {
    try {
        const feedbacks = await TirupatiPremvati.find();
        res.json({feedbacks});
    } catch (error) {
...
const assignFeedback = async (req, res) => {
    ...
    try {
        const feedback = await TirupatiPremvati.findById(id);
...
const getFeedbacksByRole = async (req, res) => {
    try {
        ...
        const feedbacks = await TirupatiPremvati.find(query);
...
const deleteFeedback = async (req, res) => {
    try {
      ...
      const deletedRecord = await TirupatiPremvati.findByIdAndDelete(id);
