...
const createFeedback = [
    ...
    async (req, res) => {
        try {
            ...
            const newForm = new MavdiPremvati({
                ...feedbackData,
...
const getFeedbacks = async (req, res) => {
    try {
        const feedbacks = await MavdiPremvati.find();
        res.json({feedbacks});
    } catch (error) {
...
const assignFeedback = async (req, res) => {
    ...
    try {
        const feedback = await MavdiPremvati.findById(id);
...
const getFeedbacksByRole = async (req, res) => {
    try {
        ...
        const feedbacks = await MavdiPremvati.find(query);
...
const deleteFeedback = async (req, res) => {
    try {
      ...
      const deletedRecord = await MavdiPremvati.findByIdAndDelete(id);
