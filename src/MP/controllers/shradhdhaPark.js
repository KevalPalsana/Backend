...
const createFeedback = [
    ...
    async (req, res) => {
        try {
            ...
            const newForm = new ShradhdhaParkPremvati({
                ...feedbackData,
...
const getFeedbacks = async (req, res) => {
    try {
        const feedbacks = await ShradhdhaParkPremvati.find();
        res.json({feedbacks});
    } catch (error) {
...
const assignFeedback = async (req, res) => {
    ...
    try {
        const feedback = await ShradhdhaParkPremvati.findById(id);
...
const getFeedbacksByRole = async (req, res) => {
    try {
        ...
        const feedbacks = await ShradhdhaParkPremvati.find(query);
...
const deleteFeedback = async (req, res) => {
    try {
      ...
      const deletedRecord = await ShradhdhaParkPremvati.findByIdAndDelete(id);
