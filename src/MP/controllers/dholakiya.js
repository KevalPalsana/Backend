...
const createFeedback = [
    ...
    async (req, res) => {
        try {
            ...
            const newForm = new DholakiyaPremvati({
                ...feedbackData,
...
const getFeedbacks = async (req, res) => {
    try {
        const feedbacks = await DholakiyaPremvati.find();
        res.json({feedbacks});
    } catch (error) {
...
const deleteFeedback = async (req, res) => {
    try {
      ...
      const deletedRecord = await DholakiyaPremvati.findByIdAndDelete(id);
...
const assignFeedback = async (req, res) => {
    ...
    try {
        const feedback = await DholakiyaPremvati.findById(id);
...
const getFeedbacksByRole = async (req, res) => {
    try {
        ...
        const feedbacks = await DholakiyaPremvati.find(query);
