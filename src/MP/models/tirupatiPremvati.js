...
const tirupatiPremvatiSchema = new mongoose.Schema({
    age: {
        type: String,
        required: true
    },
...
const TirupatiPremvati = mongoose.model('TirupatiPremvati', tirupatiPremvatiSchema);


export default TirupatiPremvati;
