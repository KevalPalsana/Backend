...
const shraddhaParkPremvatiSchema = new mongoose.Schema({
    age: {
        type: String,
        required: true
    },
...
const ShradhdhaParkPremvati = mongoose.model('ShradhdhaParkPremvati', shraddhaParkPremvatiSchema);


export default ShradhdhaParkPremvati;
