...
const sorathiyaWadiPremvatiSchema = new mongoose.Schema({
    age: {
        type: String,
        required: true
    },
...
const SorathiyaVadiPremvati = mongoose.model('SorathiyaVadiPremvati', sorathiyaWadiPremvatiSchema);


export default SorathiyaVadiPremvati;
