...
import orderSummaryController from '../controllers/orderSummary.js';
...
router.delete('/order_summary/delete-item', orderSummaryController.deleteItemFromOrderSummary);
