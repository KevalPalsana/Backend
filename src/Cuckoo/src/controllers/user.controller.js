...
const createContactUs = catchAsync(async (req, res) => {
  const contactus = await userService.createContactUs(req.body);
  sendSuccessResponse(res, 'create', contactus)
});

const createCustomer = catchAsync(async (req, res) => {
  const customer = await userService.createCustomer(req.body);
  sendSuccessResponse(res, 'create', customer)
});

export default { getProducts, getProductsBySubCategoryId, getCategories, getUserById, getSubCategories, getSubCategoryByCategoryId, createContactUs, getProductImages, getProductImagesByProdcutId, createCustomer}