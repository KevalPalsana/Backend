...
import OrderSummary from '../models/saleInvoice.model.js';


const getUserByEmail = async (email) => {
    return RameshwarUser.findOne({ email });
  };

const getUserByName = async (name) => {
    return RameshwarUser.findOne({ name });
  };
...
export default {getUserByName,updatePrimaryAddress,updateShippingAddress,addShippingAddress,getUserByEmail,getUserById,
  getUserAddressById,deleteShippingAddress, getProducts, getProductsById, getCategories, updateOrderSummaryById, deleteOrderSummaryById,
  getOrdersByUserId, getAllOrders, getOrdersByUser};
